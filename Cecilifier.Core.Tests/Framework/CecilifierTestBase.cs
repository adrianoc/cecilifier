...
public class CecilifierTestBase
{
    ...
    protected CecilifyResult CecilifyAndExecute(Stream tbc, string testBasePath)
    {
        ...
        var outputAssemblyPath = OutputAssemblyPath();
        ...
        string OutputAssemblyPath()
        {
            ...
            return Path.Combine(testBasePath, $"{TestContext.CurrentContext.Test.MethodName}-Cecilified-{BitConverter.ToString(cecilifierRunnerHash.ToArray()).Replace("-", "")}.dll");
        }
    }
