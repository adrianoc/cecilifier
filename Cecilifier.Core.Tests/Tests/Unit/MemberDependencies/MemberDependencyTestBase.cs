...
public class MemberDependencyTestBase
{
    ...
    protected static CSharpCompilation CompilationFor(params string[] code)
    {
        ...
        var comp = CSharpCompilation.Create("Test", syntaxTrees, Basic.Reference.Assemblies.Net100.References.All, new CSharpCompilationOptions(OutputKind.DynamicallyLinkedLibrary));
