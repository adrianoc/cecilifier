...
public class LocalFunctionTests : CecilifierUnitTestBase
{
    ...
    public void InTopLevel_Statements([Values("static", "")] string staticOrInstance)
    {
        ...
        Assert.That(
            cecilifiedCode,
            Contains.Substring("var m_localFoo_6 = new MethodDefinition(\"<<Main>$>g__LocalFoo|0_0\", MethodAttributes.Assembly | MethodAttributes.Static | MethodAttributes.HideBySig, assembly.MainModule.TypeSystem.Void);"),
            cecilifiedCode);
    ...
    public void InTopLevel_Statements_ForwardReferenced([Values("static", "")] string staticOrInstance)
    {
        ...
        Assert.That(
            cecilifiedCode,
            Contains.Substring("var m_localFoo_7 = new MethodDefinition(\"<<Main>$>g__LocalFoo|0_0\", MethodAttributes.Assembly | MethodAttributes.Static | MethodAttributes.HideBySig, assembly.MainModule.TypeSystem.Void);"),
            cecilifiedCode);
    ...
    public void InTopLevel_Class([Values("static", "")] string staticOrInstance)
    {
        ...
        Assert.That(
            cecilifiedCode, 
            Contains.Substring(
                "var m_localFoo_3 = new MethodDefinition(\"<Normal>g__LocalFoo|0_0\", MethodAttributes.Assembly | MethodAttributes.Static | MethodAttributes.HideBySig, assembly.MainModule.TypeSystem.Void);"));
