...
namespace ReSharperPlugin.Cecilifier.Ide.Plugin
{
    public sealed class SampleFix : QuickFixBase
    {
        ...
        {
            return _declaration.IsValid() && _declaration is IClassDeclaration;
        }
        ...
        protected override Action<ITextControl> ExecutePsiTransaction(ISolution solution, IProgressIndicator progress)
        {
            ...
            var classDeclaration = (IClassDeclaration) _declaration;
            
            // This is greatly simplified, since we're not updating any references
            // You will probably see a small indicator in the lower-right
            // that tells you about an exception being thrown.
            //classDeclaration.SetName(classDeclaration.DeclaredName.ToLower());
            
            MessageBox.ShowInfo(classDeclaration.GetText(), "Class");
