...
namespace Cecilifier.Core.Naming
{
    public interface INameStrategy
    {
        ...
        string Constructor(BaseTypeDeclarationSyntax declaringType);
        ...
        string MethodReference(string baseName, string declaringTypeName);
        ...
        string GenericInstanceMethod(IMethodSymbol method);
