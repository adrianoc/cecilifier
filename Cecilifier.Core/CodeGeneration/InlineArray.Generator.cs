...
internal class InlineArrayGenerator
{
    ...
    public static string GetOrGenerateInlineArrayType(IVisitorContext context, int elementCount, string comment)
    {
        ...
        if (!exists)
        {
            ...
            var fieldExps = context.ApiDefinitionsFactory.Field(context, new BodiedMemberDefinitionContext(fieldVar, typeVar, MemberOptions.None, IlContext.None), declaringTypeName, "_element0", typeParameterVar, "FieldAttributes.Private", false, false, null);
