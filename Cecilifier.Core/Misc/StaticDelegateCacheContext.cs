...
public struct StaticDelegateCacheContext
{
    ...
    public string EnsureCacheBackingFieldIsEmitted(string delegateType)
    {
        ...
        var fieldExps = context.ApiDefinitionsFactory.Field(context, new MemberDefinitionContext(CacheBackingField, (string)cacheTypeVar, MemberOptions.None, IlContext.None), cacheInnerTypeName, backingFieldName, delegateType, Constants.Cecil.StaticFieldAttributes, false, false, null);
